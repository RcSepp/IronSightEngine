...
SWIGEXPORT void * SWIGSTDCALL CSharp_Engine_Run(void * jarg1, void * jarg2, void * jarg3, void * jarg4, void * jarg5) {
  ...
  arg1 = (Engine *)jarg1; 
  argp2 = (INITFUNC *)jarg2; 
  if (!argp2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "Attempt to dereference null INITFUNC", 0);
    return 0;
  }
  arg2 = *argp2; 
  argp3 = (INITFUNC *)jarg3; 
  if (!argp3) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "Attempt to dereference null INITFUNC", 0);
    return 0;
  }
  arg3 = *argp3; 
  argp4 = (CYCLICFUNC *)jarg4; 
  if (!argp4) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "Attempt to dereference null CYCLICFUNC", 0);
    return 0;
  }
  arg4 = *argp4; 
  argp5 = (QUITFUNC *)jarg5; 
  if (!argp5) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "Attempt to dereference null QUITFUNC", 0);
    return 0;
  }
  arg5 = *argp5; 
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_Console() {
  void * jresult ;
  Console *result = 0 ;
