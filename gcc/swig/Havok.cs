...
public class Havok : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          ISMathPINVOKE.delete_Havok(swigCPtr);
        }
  ...
  public Havok() : this(ISMathPINVOKE.new_Havok__SWIG_0(), true) {
  }

  public Havok(SWIGTYPE_p_IHavok src) : this(ISMathPINVOKE.new_Havok__SWIG_1(SWIGTYPE_p_IHavok.getCPtr(src)), true) {
  }

  public SWIGTYPE_p_IHavok __deref__() {
    global::System.IntPtr cPtr = ISMathPINVOKE.Havok___deref__(swigCPtr);
