...
public class GuiFactory : global::System.IDisposable {
  private global::System.Runtime.InteropServices.HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal GuiFactory(global::System.IntPtr cPtr, bool cMemoryOwn) {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          ISMathPINVOKE.delete_GuiFactory(swigCPtr);
        }
  ...
  public GuiFactory() : this(ISMathPINVOKE.new_GuiFactory__SWIG_0(), true) {
  }
