...
public class OpenGL : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          ISMathPINVOKE.delete_OpenGL(swigCPtr);
        }
  ...
  public OpenGL() : this(ISMathPINVOKE.new_OpenGL__SWIG_0(), true) {
  }

  public OpenGL(SWIGTYPE_p_IOpenGL src) : this(ISMathPINVOKE.new_OpenGL__SWIG_1(SWIGTYPE_p_IOpenGL.getCPtr(src)), true) {
  }

  public SWIGTYPE_p_IOpenGL __deref__() {
    global::System.IntPtr cPtr = ISMathPINVOKE.OpenGL___deref__(swigCPtr);
