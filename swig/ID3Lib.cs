...
public class ID3Lib : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          IronSightEnginePINVOKE.delete_ID3Lib(swigCPtr);
        }
  ...
  public ID3Lib() : this(IronSightEnginePINVOKE.new_ID3Lib__SWIG_0(), true) {
  }

  public ID3Lib(SWIGTYPE_p_IID3Lib src) : this(IronSightEnginePINVOKE.new_ID3Lib__SWIG_1(SWIGTYPE_p_IID3Lib.getCPtr(src)), true) {
  }

  public SWIGTYPE_p_IID3Lib __deref__() {
    global::System.IntPtr cPtr = IronSightEnginePINVOKE.ID3Lib___deref__(swigCPtr);
