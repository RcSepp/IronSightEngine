...
public class Forms : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          IronSightEnginePINVOKE.delete_Forms(swigCPtr);
        }
  ...
  public Forms() : this(IronSightEnginePINVOKE.new_Forms__SWIG_0(), true) {
  }

  public Forms(SWIGTYPE_p_IForms src) : this(IronSightEnginePINVOKE.new_Forms__SWIG_1(SWIGTYPE_p_IForms.getCPtr(src)), true) {
  }

  public SWIGTYPE_p_IForms __deref__() {
    global::System.IntPtr cPtr = IronSightEnginePINVOKE.Forms___deref__(swigCPtr);
