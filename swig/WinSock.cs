...
public class WinSock : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          IronSightEnginePINVOKE.delete_WinSock(swigCPtr);
        }
  ...
  public WinSock() : this(IronSightEnginePINVOKE.new_WinSock__SWIG_0(), true) {
  }

  public WinSock(SWIGTYPE_p_IWinSock src) : this(IronSightEnginePINVOKE.new_WinSock__SWIG_1(SWIGTYPE_p_IWinSock.getCPtr(src)), true) {
  }

  public SWIGTYPE_p_IWinSock __deref__() {
    global::System.IntPtr cPtr = IronSightEnginePINVOKE.WinSock___deref__(swigCPtr);
